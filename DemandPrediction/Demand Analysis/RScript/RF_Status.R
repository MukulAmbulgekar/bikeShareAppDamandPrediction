...
for(i_station in unique(stations$station_id)){
  train <- fromJSON(paste0("DataStatus/",i_station,"_BikeStation_Status_Train.json"), flatten=TRUE)
  test <- fromJSON(paste0("DataStatus/",i_station,"_BikeStation_Status_Test.json"), flatten=TRUE)
  ...
  write(feature, paste('Prediction/RandomForestStatus/',i_station,"_Prediction_Status_RF_FeatureImportance.json",sep=""))
  ...
  ggsave(paste0("Prediction/RandomForestStatus/",i_station,"_Status_feature_importance.png"), p,  width = 40, height = 40, units = "cm")
  ...
  write(json, paste('Prediction/RandomForestStatus/',i_station,"_Prediction_Status_RF.json",sep=""))
