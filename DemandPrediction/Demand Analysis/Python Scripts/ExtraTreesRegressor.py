if __name__ == '__main__':
	...
	for i_station in uniqueStations:
		...
		clf= ensemble.ExtraTreesRegressor(n_estimators=100)
		...
		df.reset_index().to_json('../Prediction/ExtraTreesClassifierTrips/'+str(i_station)+'_Prediction_ET.json',orient='records')
